                                ...
                                <div class="form-group">
                                    ...
                                    <select name="category_id" class="form-control">
                                        ...
                                        @foreach ($categories as $key => $value)
                                            <option value="{{ $key }}"
                                                @if ($key === $post->category->id) selected @endif>{{ $value }}
                                            </option>
                                        @endforeach
                                    </select>
                                    @error('category_id')
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="seo_canonical" class="form-control" name="seo_canonical" type="text"
                                        value="{{ $post->seo_canonical }}">
                                </div>
                                <div class="form-group ">
                                    <label for="seo_keyword" class="">Thẻ Meta Keyword</label>
                                    <textarea id="seo_keyword" class="form-control" rows="3" name="seo_keyword" cols="50">{{ $post->seo_keyword }}</textarea>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group ">
                                    <label for="seo_desc" class="">Thẻ Meta Description</label>
                                    <textarea id="seo_desc" class="form-control" rows="3" name="seo_desc" cols="50">{{ $post->seo_desc }}</textarea>
                                </div>
                                <div class="form-group">
