...
@endsection
@section('seo')
    <meta name="robots" content="{{ $post->meta_robot }}">
    ...
    <meta property="og:url" content="{{ route('single.post', $post->slug) }}">
                ...
                <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                    <div class="page-wrapper">
                        <div class="blog-title-area text-center">
                            ...
                            <span class="color-orange"><a href="{{ route('category.post', $post->category->slug) }}"
                            ...
                            <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="blog-list-widget">
                                            <div class="list-group">
                                                <a href="{{ route('single.post', $post->previous()->slug) }}"
                                                    class="list-group-item list-group-item-action flex-column align-items-start">
                                                    <div class="w-100 justify-content-between text-right">
                                                        <img src="{{ asset('uploads/post/' . $post->previous()->thumbnail) }}"
                                ...
                                @if ($post->next())
                                    <div class="col-lg-6">
                                        <div class="blog-list-widget">
                                            <div class="list-group">
                                                <a href="{{ route('single.post', $post->next()->slug) }}"
                                                    class="list-group-item list-group-item-action flex-column align-items-start">
                                                    <div class="w-100 justify-content-between">
                                                        <img src="{{ asset('uploads/post/' . $post->next()->thumbnail) }}"
                                ...
                                @foreach ($related as $post)
                                    <div class="col-lg-6">
                                        <div class="blog-box">
                                            ...
                                            <div class="blog-meta">
                                                <h4><a href="{{ route('single.post', $post->slug) }}"
                                                        title="">{{ $post->title }}</a></h4>
                                                <small><a href="{{ route('category.post', $post->category->slug) }}"
